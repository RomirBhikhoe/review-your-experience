    ...
    try {
        if(isset($_POST['verzenden'])) {
            ...
            if(count($errors) === 0) {
                ...
                $query = $db->prepare("INSERT INTO review(titel, text, game_id, score, username)
                                                VALUES (:titel, :text, :game_id, :score, :username)");
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8 header-bg">
                                <div class="card-body header-bg p-5">
                                    ...
                                    <p class="card-text">Gemiddelde score:  </p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        foreach($review as $reviewData) {
                                            ...
                                            "
                                             <div class='card mb-3' style='max-width: 400px;'>
                                                <div class='row g-0'>
                                                    <div class='col-md-2'>
                                                        <img src='img/profile_pictures/avatar_maken_in_whatsapp2.png' class='img-fluid rounded-circle mx-auto d-block pt-3' style='max-width: 50px;' alt=''...''>
                                                    </div>
                                                    <div class='col-md-10'>
                                                        <div class='card-body'>
