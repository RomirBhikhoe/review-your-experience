...
<main>
    <div class="container-fluid main-bg">
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-2 d-flex justify-content-center">
                <a href="xbox.php">
                    <button class="btn btn-lg main-btn text-light">Xbox</button>
                </a>
            </div>
            <div class="col-2 d-flex justify-content-center">
        ...
        <div class="row text-light text-center">
            <h1>Top games voor Nintendo Switch</h1>
        </div>
        <div class="row justify-content-between g-4">
            ...
            include("dbconnect.php");
            global $db;
            $query = $db->prepare("SELECT * FROM games WHERE console_id = 3");
            $query->execute();
                ...
                foreach($result as $data) {
                    ...
                    <div class='col-4 d-flex justify-content-center'>
                        ...
                        <div class='card-body text-center'>
                            ...
                            <a href='gameinfo.php?id=" . $data['id'] . "'class='btn btn-dark'>BEKIJK</a>
                        </div>
                        </div>
                     </div>
                    ";
